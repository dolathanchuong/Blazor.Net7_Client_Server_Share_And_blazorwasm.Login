using blazorwasm.Login.Models;
using blazorwasm.Login.Models.Account;
using Microsoft.AspNetCore.Components;
using blazorwasm.Login.Services;

namespace blazorwasm.Login.Services
{
    public interface IAccountService
    {
        User? User { get; }
        Task Initialize();
        Task Login(Models.Account.Login model);
        Task Logout();
    ...
    public class AccountService : IAccountService
    {
        ...
        public async Task Login(Models.Account.Login model)
        {
